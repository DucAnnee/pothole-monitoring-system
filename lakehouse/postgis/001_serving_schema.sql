...
BEGIN
  ...
  VALUES (
    ...
    NEW.latest_raw_image_object_key,
    NEW.latest_bev_object_key,
    NEW.updated_at
  )
  ON CONFLICT (defect_id) DO UPDATE SET
    ...
    latest_raw_image_object_key = EXCLUDED.latest_raw_image_object_key,
    latest_bev_object_key = EXCLUDED.latest_bev_object_key,
...
AFTER INSERT OR UPDATE ON serving.current_road_defects_projection_inbox
