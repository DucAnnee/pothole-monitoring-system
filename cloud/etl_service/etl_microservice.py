...
POLARIS_URL = config.polaris_url
POLARIS_CREDENTIALS = config.polaris_credentials
POLARIS_WAREHOUSE = config.polaris_warehouse
ICEBERG_CATALOG_NAME = config.iceberg_catalog_name
...
CREATE TABLE IF NOT EXISTS iceberg.city.severity_scores (
    ...
    severity_score INTEGER NOT NULL COMMENT 'Calculated severity (1-10 integer scale)',
